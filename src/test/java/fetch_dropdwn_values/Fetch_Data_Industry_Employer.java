...
public class Fetch_Data_Industry_Employer {
...
//        driver.findElement(By.xpath("(//a[@href='/jobPosting'])[1]")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("(//span[text()='Industry'])[2]")).click();
        Thread.sleep(2000);
 ...
 //       WebElement dropdown  =  driver.findElement(By.xpath("//input[@placeholder='Start typing here']/../div[1]/div"));
        ...
        try {
        wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//div[@class='search-result']")));
        
        List<WebElement> optionsinDropdown = driver.findElements(By.xpath("//div[@class='search-result']"));
  ...
  //          System.out.println(optionText);
     ...
     // Create a new Excel workbook and sheet
        ...
        Sheet sheet = workbook.createSheet("Industry_Employer");
