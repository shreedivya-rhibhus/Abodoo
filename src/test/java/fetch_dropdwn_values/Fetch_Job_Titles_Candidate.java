...
public class Fetch_Job_Titles_Candidate {
	...
	public static void main(String[] args) throws InterruptedException {
	 ...
	 WebDriverManager.chromedriver().setup();
      ...
      Thread.sleep(3000);
      driver.findElement(By.xpath("(//h5[text()='Desired Jobs Titles ']/button)[1]")).click();
      Thread.sleep(2000);
 ...
 //       List<WebElement> optionsinDropdown = driver.findElements(By.xpath("//div[@class=' css-j9ez5e']/div/div/div"));
  ...
  //          System.out.println(optionText);
     ...
     // Create a new Excel workbook and sheet
        ...
        Sheet sheet = workbook.createSheet("Job Titles");
